...
{
    GPIOB->ODR &= ~(1<<12);
    bb_write_bit(((halfword &= (1<<15)) >> 15));
    bb_write_bit(((halfword &= (1<<14)) >> 14));
    bb_write_bit(((halfword &= (1<<13)) >> 13));
    bb_write_bit(((halfword &= (1<<12)) >> 12));
    bb_write_bit(((halfword &= (1<<11)) >> 11));
    bb_write_bit(((halfword &= (1<<10)) >> 10));
    bb_write_bit(((halfword &= (1<<9)) >> 9));
    bb_write_bit(((halfword &= (1<<8)) >> 8));
    bb_write_bit(((halfword &= (1<<7)) >> 7));
    bb_write_bit(((halfword &= (1<<6)) >> 6));
    bb_write_bit(((halfword &= (1<<5)) >> 5));
    bb_write_bit(((halfword &= (1<<4)) >> 4));
    bb_write_bit(((halfword &= (1<<3)) >> 3));
    bb_write_bit(((halfword &= (1<<2)) >> 2));
    bb_write_bit(((halfword &= (1<<1)) >> 1));
    bb_write_bit(((halfword &= (1<<0)) >> 0));
    GPIOB->ODR |= (1<<12);
}
